    ...
    <div className='container' style={{ marginTop:'100px' }}>
        ...
        <div className="row mt-3">
            <div className="col-md-7">
                ...
                <p>
                    Apakah kamu mencari pengalaman perjalanan yang lebih pribadi dan eksklusif? <br />
                    Smartway menawarkan private tour yang dirancang khusus untuk memenuhi kebutuhan dan preferensi kamu. Dengan private tour, kamu akan mendapatkan:
                    <ul>
                        <li className='mt-2'>
                            <b><Image src={'/img/icons/checklist.svg'} width={20} height={20} /> Kebebasan Penuh</b> <br />
                            Rencanakan jadwal perjalanan kamu sesuai keinginan tanpa terganggu oleh orang lain.
                        </li>
                        <li className='mt-2'>
        ...
        <div className="row" style={{ marginTop:'100px' }}>
            ...
            <div className="col-md-7">
                <h3 className="fw-bold">
                    Wujudkan Petualangan Impian kamu!
                </h3>
                <p>
                    ...
                    <ul>
                        <li className='mt-2'>
                            ...
                            Atur anggaran liburan kamu dengan mudah dan efektif.
                        </li>
                        <li className='mt-2'>
                            <b><Image src={'/img/icons/checklist.svg'} width={20} height={20} /> Destinasi Eksklusif</b> <br />
                            Jelajahi destinasi impian kamu tanpa beban biaya yang memberatkan.
                        </li>
                        <li className='mt-2'>
                            <b><Image src={'/img/icons/checklist.svg'} width={20} height={20} /> Keamanan dan Kenyamanan</b> <br />
                            Tabungan kamu aman bersama kami, sehingga kamu bisa merencanakan liburan dengan tenang.
                        </li>
                        <li className='mt-2'>
                            <b><Image src={'/img/icons/checklist.svg'} width={20} height={20} /> Bunga Menarik</b> <br />
                            Dapatkan bunga tabungan yang kompetitif untuk mempercepat tercapainya impian kamu.
                        </li>
                    </ul>
                </p>
                <Link
