...
export default function CarGallery({documentations}) {
  // console.log(documentations)

   // Mengambil semua original_url dari media di setiap documentation
   const slides = documentations.flatMap((doc) => 
    doc.media.map((mediaItem) => mediaItem.original_url)
  );
